                ...
                <div class="topbar-left"  style="background: #36404e !important">
                    ...
                    <a href="{{ url('/') }}" class="logo">
                        <span>
                            <img src="{{ url('assets/images/logo.png') }}" alt="" style="width: 110px;height: 120px;">
                        </span>
                        <i>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                <a href="#" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <img src="{{ Auth::user()->gravatar }}" alt="user-img" class="img-circle user-img">
                                </a>
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        <!-- <li><a href="javascript:void(0)"><i class="ti-user m-r-5"></i> Edit Profile</a></li>
                                        <li><a href="javascript:void(0)"><i class="ti-settings m-r-5"></i> Settings</a></li>
                                        <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li> -->
                                        <li><a href="{{ route('user.edit', Auth::user()->id) }}"><i class="ti-user m-r-5"></i> Edit Profile</a></li>
                                        <li><a onclick="document.getElementById('form-logout').submit()" href="javascript:void(0)"><i class="ti-power-off m-r-5"></i> Logout</a></li>
