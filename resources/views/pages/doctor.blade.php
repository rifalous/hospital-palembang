...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('doctor.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Dokter</a>
        </div>
        <div class="col-xs-12 text-right">
            ...
            <a href="{{ route('doctor.export') }}" class="btn btn-custom btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-download"></i> Eksport</a>
        </div>
        <!-- end col -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-doctor">
                    <thead>
                        <tr>
                            <th>Kode</th>
                            <th>NIP </th>
...
<script src="{{ url('assets/js/pages/doctor.js') }}"></script>
@endpush