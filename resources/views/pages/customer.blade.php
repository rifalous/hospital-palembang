...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('customer.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create Customer</a>
        </div><!-- end col -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-customer">
                    <thead>
                        <tr>
                            <th>Customer Code</th>
                            <th>Customer Name</th>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('customer.import') }}" method="post" enctype="multipart/form-data" id="form-import">
                            @csrf
                            <div class="form-group">
                                <label class="control-label">Select File</label>
                                <input type="file" name="file" class="form-control" accept=".csv">
                                <center><a href="{{ route('customer.template') }}" ><i class="mdi mdi-download"></i> Template Master Customer.csv</a>   </center>
                            </div>
                        </form>
                    </div>
                </div>
...
<script src="{{ url('assets/js/pages/customer.js') }}"></script>
@endpush