    ...
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Pemeriksaan Lab</h4>
            ...
            <div class="row m-b-30">
              <div class="col-md-8">
                <div class="pull-left">
                  ...
                  <a class="btn btn-primary btn-bordered waves-effect waves-light" href="{{ url('lab_checkup/create') }}"><i class="mdi mdi-plus"></i> Tambah </a>
