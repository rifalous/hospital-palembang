    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Pemeriksaan Labolatorium</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="#">Pemeriksaan Labolatorium</a>
                    </li>
                    <li class="active">
                        Data Pemeriksaan Labolatorium
                    </li>
                </ol>
        ...
        <div class="col-xs-12">
            <div class="card-box">
                        ...
                        <div class="pull-right">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" type="button" onclick="on_search()"
                                        data-toggle="tooltip" data-original-title="Search"><i
                                            class="mdi mdi-magnify"></i></button>
                                    <button class="btn btn-primary btn-sm" type="button" onclick="on_clear_search()"
                                        data-toggle="tooltip" data-original-title="Clear"><i
                ...
                <div class="table-responsive">
                    <table id="table-lab-checkup" class="table table-bordered">
                        <thead>
                            <tr>
								<th style="width: 50px"></th>
                                <th>Nama Pasien/No Registrasi</th>
                                <!-- <th>Test Labolatorium</th> -->
                                <th>Total Biaya</th>
