...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Tambah Registrasi Rawat Jalan </h4>
    ...
    <form method="post" action="{{ route('registration_outpatient.store') }}" id="form-add-edit">
        @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_registrasi" placeholder="eg: 00001" class="form-control" value="{{$getCodeOutpatient}}" readonly="readonly" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <select name="poliklinik" class="select2" data-placeholder="Pilih Poliklinik" data-allow-clear="true" required="required">
                                    ...
                                    @foreach ($polikliniks as $poliklinik)
                                        <option value="{{ $poliklinik['id'] }}">{{ $poliklinik['text'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_periksa" class="form-control datepicker" placeholder="yyyy-mm-dd" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" readonly="readonly" required="required">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="complaint" class="form-control" placeholder="eg: Perut Sakit" rows="4" required="required"></input>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
