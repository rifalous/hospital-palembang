...
<div class="container">
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Master Pasien</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('pasien.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Pasien</a>
        </div>
        <div class="col-xs-12 text-right">
            ...
            <a href="{{ route('pasien.export') }}" class="btn btn-custom btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-download"></i> Eksport</a>
        </div>
        <!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-pasien">
                    <thead>
                        <tr>
...
<script src="{{ url('assets/js/pages/pasien.js') }}"></script>
@endpush