...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master Section</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('section.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Section</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-section">
                    <thead>
                        <tr>
                            <th>Section Code</th>
                            <th>Section Name</th>
...
<script src="{{ url('assets/js/pages/section.js') }}"></script>
@endpush