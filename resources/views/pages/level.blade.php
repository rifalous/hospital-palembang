...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master Kelas</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('level.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Kelas</a>
        </div>
        <div class="col-xs-12 text-right">
            ...
            <a href="{{ route('level.export') }}" class="btn btn-custom btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-download"></i> Eksport</a>
        </div>
        <!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-level">
                    <thead>
                        <tr>
                            <th>Kode</th>
                            <th>Kelas</th>
...
<script src="{{ url('assets/js/pages/level.js') }}"></script>
@endpush