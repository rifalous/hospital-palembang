                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="pasien_id" class="select2" data-placeholder="Pilih No Rekam Medis" data-allow-clear="true" required="required">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="entry_procedure" class="select2" data-placeholder="Pilih Prosedur Masuk" data-allow-clear="true" readonly="readonly">
                                    <option></option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_masuk" class="form-control datepicker" placeholder="yyyy-mm-dd" value="{{ $registration_inpatient->tgl_masuk }}" readonly="readonly" readonly="readonly">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="room_id" class="select2" data-placeholder="Pilih Ruangan" data-allow-clear="true" readonly="readonly">
                                    <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <select disabled name="person_in_charge" class="select2" data-placeholder="Pilih Penanggung Jawab" data-allow-clear="true" readonly="readonly">
                                    <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control" placeholder="eg: Jl. Pahlawan No 80 Block C-01" rows="5" readonly="readonly">{{ $registration_inpatient->address }}</textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="doctor_id" class="select2" data-placeholder="Pilih Dokter" data-allow-clear="true" readonly="readonly">
                                    <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="eg: Danny" class="form-control" value="{{ $registration_inpatient->name }}" readonly="readonly">
                                <span class="help-block"></span>
                            </div>
                            <div class="form-group">
                                <label class="control-label">No Telepon<span class="text-danger">*</span></label>
                                <input type="text" name="phone" placeholder="eg: 02122xxx" class="form-control number" value="{{ $registration_inpatient->phone }}" readonly="readonly"></input>
                                <span class="help-block"></span>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="disease" value="{{ $registration_inpatient->disease }}" class="form-control" placeholder="eg: Flu" rows="4" readonly="readonly" maxlength="35"></input>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="complaint" value="{{ $registration_inpatient->complaint }}" class="form-control" placeholder="eg: Perut Sakit" rows="4" readonly="readonly" maxlength="35"></input>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
