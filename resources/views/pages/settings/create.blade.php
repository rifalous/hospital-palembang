...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <form method="post" action="{{ route('settings.store') }}" id="form-add-edit">
                        @csrf
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Kunci <span class="text-danger">*</span></label>
                                <input type="text" name="key" class="form-control" placeholder="Kunci" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" placeholder="Nilai" name="value" class="form-control"></textarea>
                            </div>
                        </div>
