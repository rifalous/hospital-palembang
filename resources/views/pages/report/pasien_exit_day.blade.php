...
@section('title')
  Laporan Pasien keluar Perhari
@endsection

@section('content')

@php($active = 'pasien_exit_day')

<div class="container">
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Laporan Pasien keluar Perhari</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li class="active">
                    Pasien keluar Perhari
                    </li>
                </ol>
      ...
      <div class="card-box">
        <div class="row m-b-30">
          <div class="form-group">
            <form action="{{ url('pasien_exit_day/download') }}" method="post">
              @csrf
              <div class="col-md-2">
                <div class="form-group">
          ...
          <table id="table-pasien-exit-day" class="table table-bordered table-responsive">
            <thead>
              <tr>  
                <th>No Registrasi</th>
                <th>Nama Pasien</th>
...
<script src="{{ url('assets/js/pages/pasien_exit_day.js') }}"></script>
@endpush