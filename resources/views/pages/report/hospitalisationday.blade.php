...
@section('title')
  Laporan Pembayaran Rawat Jalan
@endsection
    ...
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Laporan Pembayaran Rawat Jalan</h4>
      ...
      <div class="card-box">
        <div class="row m-b-30">
          <div class="form-group">
            <div class="col-md-2">
              <form action="{{ url('hospitalisation_day/download') }}" method="post">
                @csrf
                <div class="form-group">
          ...
          <table id="table-hospitalisationday" class="table table-bordered table-responsive">
            <thead>
              <tr>  
                <th>No Registrasi</th>
                <th>Nama</th>
...
<script src="{{ url('assets/js/pages/hospitalisationday.js') }}"></script>
@endpush