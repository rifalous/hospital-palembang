...
@section('title')
  Laporan Pembayaran Rawat Jalan Periode
@endsection
  ...
  <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Laporan Pembayaran Rawat Jalan Periode</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li class="active">
                    Pembayaran Rawat Jalan Periode
                    </li>
                </ol>
      ...
      <div class="card-box">
        <div class="row m-b-30">
          <div class="form-group">
            <form action="{{ url('hospitalisation_periode/download') }}" method="post">
              @csrf
              <div class="col-md-2">
                <div class="form-group">
          ...
          <table id="table-hospitalisationperiode" class="table table-bordered table-responsive">
            <thead>
              <tr>  
                <th>No Registrasi</th>
                <th>Nama</th>
...
<script src="{{ url('assets/js/pages/hospitalisationperiode.js') }}"></script>
@endpush