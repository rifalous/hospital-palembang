...
<div class="container">
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">System Master</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('system.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah System</a>
        </div>
        <div class="col-xs-12 text-right">
            ...
            <a href="{{ route('system.export') }}" class="btn btn-custom btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-download"></i> Eksport</a>
        </div>
        <!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-system">
                    <thead>
                        <tr>
                            <th>System Type</th>
                            <th>System Code</th>
...
<script src="{{ url('assets/js/pages/system.js') }}"></script>
@endpush