...
@php($active = 'settings/role')
	...
	<div class="container">
        ...
        <div class="row">
			<div class="col-xs-12">
				<div class="page-title-box">
                    <h4 class="page-title">Tambah Peran</h4>
        ...
        <form action="{{ route('role.store') }}" method="post" id="form-add-edit">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-content">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Nama Peran" required="required">
                            ...
                            <ul class="no-list">
                                <li>
                                    <div class="checkbox checkbox-primary">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="parent parent-{{ $permission->id }}" data-value="{{ $permission->id }}">
                                        <label for="checkbox2">
                                    ...
                                    <ul class="no-list">
                                        ...
                                        <li>
                                            <div class="checkbox checkbox-primary">
                                                <input type="checkbox" name="permissions[]" value="{{ $children->id }}" class=" children children-{{ $permission->id}}" data-value="{{ $permission->id }}">
                                                <label for="checkbox2">
