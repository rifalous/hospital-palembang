...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 m-b-20">
            <div class="pull-left">
                <a href="{{ route('permission.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light"><i class="mdi mdi-plus"></i>Tambah Izin Baru</a>
            </div>
        </div>
    	<div class="col-md-12">
            <table class="table table-bordered" id="tbl-permission">
                <thead>
                    <tr>
                        <th>Nama</th>
                        <th>Parent</th>
...
@push('js')
<script src="{{ url('assets/js/pages/permission.js') }}"></script>
