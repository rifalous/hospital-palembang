...
<div class="container">
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Tambah Pasien Keluar</h4>
    ...
    <form method="post" action="{{ route('patient_exits.store') }}" id="form-add-edit">
        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="no_registrasi" class="select2" data-placeholder="Pilih Nomor Registrasi" required="required">
                                    ...
                                    @foreach ($inpatients as $inpatient)
                                        <option value="{{ $inpatient['id'] }}">{{ $inpatient['no_registrasi'] }} - {{ $inpatient->pasien['name'] }} - {{ $inpatient->pasien->details['identification_number'] }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> 
                            <div class="form-group">
                                ...
                                <input name="disease" class="form-control" placeholder="eg: Perut Sakit" rows="4" required="required"></input>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tgl_keluar" class="form-control datepicker" placeholder="yyyy-mm-dd" required="required" readonly="readonly">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="time_keluar" class="form-control" placeholder="eg: 15:30" required="required">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="way_out" class="select2" data-placeholder="Pilih Cara Keluar" data-allow-clear="true" required="required">
                                    ...
                                    @foreach ($way_outs as $way_out)
                                        <option value="{{ $way_out['id'] }}">{{ $way_out['text'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="exit_state" class="select2" data-placeholder="Pilih Keadaan Keluar" data-allow-clear="true" required="required">
                                    ...
                                    @foreach ($exit_states as $exit_state)
                                        <option value="{{ $exit_state['id'] }}">{{ $exit_state['text'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="total_biaya" class="form-control" placeholder="eg: Rp. 1.000.000" rows="4" required="required"></input>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
