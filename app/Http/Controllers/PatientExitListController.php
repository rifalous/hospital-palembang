...
class PatientExitListController extends Controller
{
    /**
    ...
    {
        return view('pages.report.pasien_exit_list');
    ...
    public function getData(Request $request){
        ...
        $data = PatientExits::with(['room','pasien'])
                            ...
                            ->whereDate('tgl_keluar','<=', $request->end_date)
                            ->get();
    ...
    public function download(Request $request)  
    {
        ...
        return $pdf->setPaper('a4', 'potrait')
           ->stream('Laporan Pasien Keluar Periode.pdf');
        } else {
